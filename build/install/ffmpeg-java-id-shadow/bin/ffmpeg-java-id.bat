...
set CLASSPATH=%APP_HOME%\lib\ffmpeg-java-id-shadow-1.0.jar

@rem Execute ffmpeg-java-id
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FFMPEG_JAVA_ID_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%FFMPEG_JAVA_ID_EXIT_CONSOLE%" exit 1
exit /b 1
