...
class Curve {
    ...
    /**
     * This class's constructor with the curve's name.
     *
     * @param curve1 The curve's name
     */
    Curve(@NotNull String curve1) {
        curve = curve1;
    }
    ...
    public void setCurve(@NotNull String curve) throws InvalidArgumentException {
        ...
        switch (curve) {
            case "tri", "qsin", "hsin", "esin", "log", "ipar", "qua", "cub", "squ", "cbr", "par", "exp", "iqsin",
                 "ihsin",
                 "dese", "desi", "losi", "sinc", "isinc", "quat", "quatr", "qsin2", "hsin2", "nofade" ->
                    this.curve = curve;
