...
public class Size {
     ...
     * @param sizeID The size's ID. This value cannot be null or an empty string, and it must be accepted by FFmpeg.
     * @throws InvalidArgumentException If the given value is null or an empty string.
     */
    public Size(@NotNull String sizeID) throws InvalidArgumentException {
     ...
     */
    public static boolean checkSizeID(@NotNull String sizeID) {
